...
- [inventario-armas.md](inventario-armas.md) — **inventario + armas data-driven**: registro `WEAPONS`, equipar con [I]; la **viola de Les Luthiers** (premio del tesoro) dispara RISAS (gente→música, drones→vuelan por el heavy metal); el **fierro criollo** va al inventario pero el Carpo se niega a usarlo en la calle (gag pacifista) y **solo lo usa en los sueños/niveles generados**, cada arma eficaz vs un tipo de bicho (grafo de objeto) (F1 hecho v210-216; §6 criollo-en-sueños = Draft).
- [multijugador.md](multijugador.md) — **zona multijugador** (cine de Lavalle): F1 cine "EN VIVO" (presencia+ticker) + F2 **BODEGÓN** real-time por SSE (co-presencia + emotes + frases preset + **chat privado 1-a-1**); `salon-server` en el ai-proxy. F1/F2a/F2b.1/F2b.2 HECHO; F2b.3 mesas + F3 truco PvP pendientes.
- [telo-chip-quest.md](telo-chip-quest.md) — **el giro del telo**: la "rubia" es un ROBOT IA que te quiere chipar; si te atrapa, arranca un arco para sacarte el chip con **cambio de personaje** (controlás al pibe de Garbarino) → troyano (Maxi/Marcos) → jubilados de TecToys/Commodore → comprar consola en el chino → curar el chip. Q0 (twist huir/chipear) HECHO v220; Q1-Q4 = arco grande por fases (Draft, idea del dueño 2026-06-28).
- [construccion-colaborativa.md](construccion-colaborativa.md) — **construir algo entre todos (estilo Death Stranding)**: 2 pisos de **carteles** colaborativos (computadora → dejás un cartel corto que dura hasta que alguien lo lee y se borra; empaquetados; la IA acotada) + un piso de **datacenter** global (pagás partes con plata/caramelos, todos ven el estado, persiste cross-run/cross-player para destruir la IA del satélite; sala visible en cualquier nivel). Reusa el salon-server + bancos PVC (Draft, idea del dueño 2026-06-28).
