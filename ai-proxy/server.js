...
const SPACE_TABLES = { bodegon: { '1v1': 2, '6': 6 }, lavalle: { corte: 6, soga: 6, bombo: 6, olla: 6 } };
const TABLE_CAP = { '1v1': 2, '6': 6, corte: 6, soga: 6, bombo: 6, olla: 6 }; const TABLE_COUNTDOWN = 8000;
const CD_TABLES = new Set(['6', 'corte', 'soga', 'bombo', 'olla']);   // mesas que arrancan por cuenta regresiva o al llenarse (las demás = solo al llenarse)
const CD_MIN = { '6': 2, corte: 1, soga: 1, bombo: 1, olla: 1 };      // mínimo de jugadores para arrancar por cuenta regresiva (co-op = arranca solo)
