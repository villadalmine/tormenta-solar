  ...
  function build() {
    ...
    const rooms = [
      ...
      makeRoom({
        ...
        doors: [
          ...
          { id:'subteb',  art:'door',        facade:'subte',       label:'bajar al subte 🚇 (Estación Florida · Línea B)', x:68, inward:-1 },
        ...
        npcs: [
          ...
          { name:'El vecino', sprite:'civil3', x:12, action:'vecino', mov:{hasta:'stormed'}, vecino:{ edificio:'edu', interior:1 },
            dialog:'“Ese edificio... yo de noche escucho cosas, pibe. Cuando se corte la luz vas a ver.” 🏢' },
          { name:'La vecina', sprite:'mujer', x:33, action:'vecino', mov:{hasta:'stormed'}, vecino:{ edificio:'arcade', interior:4 },
            dialog:'“El arcade ese tiene historia, eh. Pero callate, que las paredes oyen.” 🕹️' },
          { name:'El sereno', sprite:'viejo', x:48, action:'vecino', mov:{hasta:'stormed'}, vecino:{ edificio:'choris', interior:5 },
          ...
          { name:'Músico', sprite:'musico', x:24, mov:false, dialog:'“Una moneda y te toco una cumbia, maestro.” 🎶' },
          ...
          { name:'Jubilado', sprite:'civil3', x:63, mov:false, dialog:'“Jaque, querido. Vas perdiendo... pagás el café.” ♟️' },
          { name:'Jubilado', sprite:'civil4', x:65, mov:false, dialog:'“Callate y movés vos, tramposo de mierda.” ♟️' },
          { name:'Viejo', sprite:'viejo', x:76, mov:false, dialog:'“Hace dos horas que espero, pibe... y no avanza.” 👴' },
          { name:'Turista', sprite:'turista', x:77.4, mov:false, dialog:'“Is this the line for dollars? ¿Acá cambian, sí?” 📸' },
          { name:'Gordo', sprite:'gordo', x:78.8, mov:false, dialog:'“Tengo un hambre... ¿cuánto falta para la cueva?” 🍔' },
          { name:'Señora', sprite:'mujer', x:80.2, mov:false, dialog:'“Yo vengo todos los días, ¿eh? No me corran.” 💅' },
          { name:'Pibe', sprite:'civil2', x:81.6, mov:false, dialog:'“Aguante, ya casi llego al arbolito.” 🧢' },
          { name:'Oficinista', sprite:'civil4', x:83, mov:false, dialog:'“Estoy en horario laboral, no le digas a nadie.” 💼' },
          { name:'Papá', sprite:'conNino', x:84.4, mov:false, dialog:'“Quedate quieto, nene, ya falta poco.” 👨‍👦' },
          { name:'Nene', sprite:'nino', x:85.8, mov:false, dialog:'“¿Faaalta muuucho, paaa?” 🍭' },
          { name:'Don', sprite:'civil3', x:87.2, mov:false, dialog:'“En mis tiempos el dólar valía dos mangos.” ☕' },
          { name:'Señora 2', sprite:'mujer', x:88.6, mov:false, dialog:'“No empujes que me sacan de la fila, atorrante.” 😤' },
          { name:'Borrachín del vino', sprite:'borracho_vino',  x:97, action:'borracho', mov:{tras:'borrachosHappy'}, want:'fiambre',
          ...
          { name:'Borrachín de la cerveza', sprite:'borracho_birra', x:100, action:'borracho', mov:{tras:'borrachosHappy'}, want:'diosa',
          ...
          { name:'Borrachín del porro', sprite:'borracho_porro', x:103, action:'borracho', mov:{tras:'borrachosHappy'}, want:'carne',
      ...
      makeRoom({
        ...
        npcs: [
          ...
          { name:'Jugador', sprite:'naipero', x:20, mov:false, dialog:'“Al fondo te esperan.”' },
        ],
      ...
      makeRoom({
        ...
        npcs: [
          ...
          { name:'En la cola', mov:false, sprite:'gordo',   x:11, dialog:'“Saqué número a las siete de la mañana, ¿eh? No me corran.” 🎫' },
          { name:'En la cola', mov:false, sprite:'mujer',   x:12, dialog:'“¿Cómo que cerró la caja? ¡Si recién abrieron!” 😤' },
          { name:'En la cola', mov:false, sprite:'viejo',   x:13, dialog:'“En mis tiempos esto se hacía en la vereda, más rápido.” 👴' },
          { name:'En la cola', mov:false, sprite:'turista', x:14, dialog:'“Is this the official rate? ...¿el oficial? ¡Pero si es la mitad!” 📸' },
          { name:'En la cola', mov:false, sprite:'civil2',  x:15, dialog:'“Hace dos horas que no avanza un paso, hermano.” 🧢' },
          { name:'En la cola', mov:false, sprite:'conNino', x:16, dialog:'“Aguantá, nene, ya casi... no, mentira, falta un montón.” 👨‍👦' },
          { name:'En la cola', mov:false, sprite:'civil4',  x:17, dialog:'“Pedí el día en el laburo para esto. Para ESTO.” 💼' },
          { name:'En la cola', mov:false, sprite:'civil3',  x:18, dialog:'“Está hasta las pelotas, no entra un alfiler más.” 😮‍💨' },
        ],
    ...
    rooms.push(makeRoom({
      ...
      npcs: [
        ...
        { name:'Mapamundi', sprite:'recepcionista', x:6.3, action:'globo', dialog:'“Mirá el mundo, gurú: los satélites rebeldes que desataron la tormenta y las bases del pueblo. [E] para abrir el mapa. 🛰️🌎”' },
        // EL PLANO DEL BÚNKER: construir tu búnker desde la entrada de tu base (Mapa B, specs/mapas-satelites-bunkers.md)
        { name:'El plano', sprite:'recepcionista', x:15.4, action:'plano', dialog:'“Acá está el PLANO, gurú: tu búnker se construye desde la entrada de tu base. Poné pasillos, catres, huerta… y defensas, que arriba en el radar la superficie está brava. [E] para abrir el plano. 📐🛖”' },
    ...
    rooms.push(makeRoom({
      ...
      npcs: [
        { name:'En la cola', mov:false, sprite:'gordo',  x:6,    dialog:'“Todo legal, ¿eh? Es para mi hijo, para cuando sea grande.” 👶' },
        { name:'En la cola', mov:false, sprite:'civil3', x:9,    dialog:'“Si no ahorro en dólares, este país se va a la mierda, pibe.” 🇦🇷' },
        { name:'En la cola', mov:false, sprite:'mujer',  x:11.5, dialog:'“Yo en el peso no confío ni loca. Verde o nada.” 💵' },
      ],
    ...
    rooms.push(makeRoom({
      ...
      npcs: [
        { name:'En la cola', mov:false, sprite:'viejo',   x:6,    dialog:'“Vengo todos los meses. Es mi cajita de ahorro, qué querés.” 🏦' },
        { name:'En la cola', mov:false, sprite:'civil4',  x:9,    dialog:'“Shhh, acá no se habla de cuánto traés, pibe.” 🤫' },
        { name:'En la cola', mov:false, sprite:'conNino', x:11.5, dialog:'“Es para el futuro del nene. Dólar, siempre dólar.” 👨‍👦' },
      ],
    ...
    rooms.push(makeRoom({
      ...
      npcs: [
        { name:'En la cola', mov:false, sprite:'civil2', x:6,    dialog:'“Acá sí te cambian. El tipo es de confianza, eh.” 💵' },
        { name:'En la cola', mov:false, sprite:'mujer',  x:9,    dialog:'“Es para mi hijo, todo legal. Bueno, legal-legal no, pero me entendés.” 👶' },
        { name:'En la cola', mov:false, sprite:'gordo',  x:11.5, dialog:'“Apurate que se hace cola. Si no ahorro verde, ¿qué le dejo a los pibes?” 🇦🇷' },
      ],
