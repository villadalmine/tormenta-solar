    ...
    const rooms = [
      ...
      makeRoom({
        ...
        npcs: [
          ...
          { name:'Borrachín del vino', sprite:'borracho_vino',  x:97, action:'borracho', want:'fiambre',
            hint:'“Uff... lo que me arreglaría un FIAMBRE ahora, pibe... un saladito, mortadela, lo que sea. Tengo el estómago raspando.” 🥓',
            lines:[
            '“¿Sabés qué pasa, pibe? El país está como yo: sin un mango, pero firme.” 🍷',
            '“Yo fui contador, ¿sabés? Contador... de chistes malos. Ja.”',
            '“Este edificio de atrás es nuestro, eh. Pero no entra cualquiera.” 🏚️',
            '“El obelisco lo construí yo, no me creen.” 🏛️' ] },
          { name:'Borrachín de la birra', sprite:'borracho_birra', x:100, action:'borracho', want:'birra',
            hint:'“Una BIRRA bien fría y soy otro, hermano... fría, eh, no me traigas una caliente como la otra vez.” 🍺',
            lines:[
            '“¡Boca campeón del mundo! ...¿no salió? Bueno, igual, salú.” ⚽',
            '“Salú... *hipo*... vos me querés, ¿no, hermano?”',
            '“Nosotros cuidamos la entrada de ese edificio. Hay que ganarse el pase, eh.” 🚪',
            '“Mañana arranco la dieta. Mañana, eh.”' ] },
          { name:'Borrachín del porro', sprite:'borracho_porro', x:103, action:'borracho', want:'carne',
            hint:'“Loco... tengo un bajón bárbaro. Me morfaría un PEDAZO DE CARNE crudo, te juro. Conseguime carne, dale.” 🥩',
            lines:[
            '“Tranqui todo, loco... ¿escuchás los pájaros? No hay pájaros. Igual.” 🌬️',
            '“El sistema, viste... el sistema, hermano.”',
            '“Si los tres quedamos contentos, te abrimos el edificio, ¿me entendés o no me entendés?” 🏚️',
            '“Este edificio antes era un banco. Ahora soy yo el banco. De nada.” 🏦' ] },
        ],
        enemies: [
      ...
      makeRoom({
        ...
        npcs: [
          ...
          { name:'Jugador', sprite:'naipero', x:15, dialog:'“Acá no, pibe. No viste nada.” 🤫' },
          ...
          { name:'Jugador', sprite:'naipero', x:16, dialog:'“Esto no existió.”' },
