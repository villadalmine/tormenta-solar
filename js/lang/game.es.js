...
(function () {
  const G = {
    ...
    'g.chip.linyerasPosta': '🫥 Ya en serio, uno te tira la posta: “esto te lo saca el PIBE DE GARBARINO. Andá a la electrónica de la calle y hablale al vendedor pesado.” Los tres se piran. 🧑‍💼',
    ...
    'g.chip.cured': '🎮💥 Cargás el troyano en la consola y se lo metés al chip. 🤖❌ El chip echa humo, chispea y se APAGA. Te marea, te DESPLOMÁS en la cama y te quedás DORMIDO un rato… 😴💤 Cuando te despertás, ya NO tenés el chip: sos vos de nuevo, el Carpo. 😮‍💨🎸 Todo volvió a la normalidad. (Te puede volver a pasar si te metés al telo de nuevo.)',
    ...
    'g.chip.hint.cure': '“Ya tenés todo: andá al inventario [I] y USÁ la consola. Eso le mete el troyano al chip.” 🎮',
