...
(function () {
  const G = {
    ...
    'g.chip.linyeras': '📱🤣 Llamás a los linyeras por el celu y se cagan de risa: “¿¡y ahora de qué bando jugás, pibe!?” Tras un ida y vuelta filosófico sin sentido (algo de Diógenes, algo de un satélite), uno te suelta: “esto te lo arregla el PIBE DE GARBARINO. Andá a la electrónica, en la calle, y hablá con el vendedor pesado.” 🧑‍💼',
    ...
    'g.chip.consola': '🕹️ Los jubilados (ex-TecToys Brasil y ex-Commodore Argentina) te llevan al chino y te consiguen una CONSOLA (−20 🪙). Queda en tu inventario [I]. “Con esto y el troyano le hackeás el chip. Usala, pibe.” 🎮',
    ...
    'g.chip.cured': '🎮💥 Cargás el troyano en la consola y se lo metés al chip. 🤖❌ El chip echa humo y se apaga. Quedás tumbado en la cama un segundo… te despertás, SIN chip, vos de nuevo (el Carpo). 😮‍💨🎸 Todo vuelve a la normalidad. (Te puede volver a pasar si te metés al telo de nuevo.)',
    'g.chip.hint.linyeras': '“Te chiparon, pibe, lo sé. Llamanos por el celu… igual nos vamos a reír un rato. Pista: el pibe de Garbarino sabe.” 📱',
    ...
    'g.chip.hint.consola': '“Te falta la consola vieja. Los jubilados de TecToys y Commodore están en el cine, piso de las Consolas. Ellos la consiguen en el chino.” 🕹️',
