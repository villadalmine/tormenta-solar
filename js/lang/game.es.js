...
(function () {
  const G = {
    ...
    'g.chip.linyerasPosta': '🫥 Tras boludearte un rato, los tres te tiran la posta: “esto te lo saca el PIBE DE GARBARINO. Ahora SOS VOS el que resuelve.” 🔄 Pasás a controlar al PIBE DE GARBARINO (🧑‍💼🤖) — salí a la calle y andá a la electrónica.',
    'g.chip.garbarino': '🧑‍💼 El vendedor de Garbarino te mira el chip: “uh, eso es de la IA, pesado. Yo no, pero VOS sí podés. A partir de ahora la manejás vos, pibe.” 🔄 Pasás a controlar AL PIBE DE GARBARINO (🧑‍💼🤖 en el HUD). “Andá a EducaciónIT: Maxi (piso 4) y Marcos (piso 9) te arman un TROYANO.”',
    ...
    'g.chip.obj.garbarino': '🧑‍💼🤖 Sos el pibe de Garbarino (chipeado). Andá a la ELECTRÓNICA de la calle (Garbarino).',
    'g.chip.obj.troyano': '🧑‍💼🤖 Conseguí el TROYANO: hablá con MAXI (EducaciónIT p4) y MARCOS (p9).',
    'g.chip.obj.consola': '🧑‍💼🤖 Andá al CINE (piso Consolas): los 2 jubilados te llevan a buscar la consola.',
    'g.chip.obj.consola2': '🧑‍💼🤖 Llevá a los jubilados al ARCADE: el flaco del Trucotron te da la consola.',
    'g.chip.obj.cure': '🤖 Buscá a CUALQUIER linyera y dale la consola para que te saque el chip.',
