...
(function () {
  const G = {
    ...
    'g.telo.chipped': '🤖💉 El robot te agarra y te clava el CHIP en la nuca. 😵 Medio robot, manoteás el CELU de la mesita y les escribís a los linyeras… se cagan de risa: “¿¡y ahora de qué bando jugás, pibe!?” 🤣 Tras un ida y vuelta filosófico sin sentido, uno te suelta: “esto te lo arregla el pibe de Garbarino, andá a verlo.” De golpe te despertás en la cama 😶‍🌫️ y huís al bar. (La misión del pibe de Garbarino para sacarte el chip: PRÓXIMAMENTE.)',
