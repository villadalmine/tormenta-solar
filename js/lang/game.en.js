...
(function () {
  const G = {
    ...
    'g.telo.bear': '🚪🕴️ Out of the weird door bursts a TWO-METER BOUNCER, all in black, masked, with glowing red eyes! “WHAT ARE YOU DOING WITH MY WIFE?!” 😱 RUN!',
    'g.telo.run': '🕴️💨 RUN, that hulk\'ll grab you!',
    'g.telo.ejected': '🕴️💥 The huge bouncer lifts you with one hand and dumps you back in the bar in one toss. The blonde, from the doorway: “maybe next time, sweetheart.” 😵💋',
