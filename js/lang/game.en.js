...
(function () {
  const G = {
    ...
    'g.chip.linyeras': '📱🤣 You call the hobos on the phone and they crack up: “so which SIDE are you playing for now, kid?!” After some pointless philosophical back-and-forth (some Diogenes, something about a satellite), one lets slip: “the GARBARINO GUY can fix this. Go to the electronics shop on the street and talk to the pushy salesman.” 🧑‍💼',
    ...
    'g.chip.consola': '🕹️ The retirees (ex-TecToys Brazil and ex-Commodore Argentina) take you to the corner shop and score you a CONSOLE (−20 🪙). It\'s in your inventory [I]. “With this and the trojan you hack the chip. Use it, kid.” 🎮',
    'g.chip.consolaNotYet': '🎮 The trojan isn\'t ready to run on the console yet. Follow the chain (the hobos drop hints).',
    'g.chip.cured': '🎮💥 You load the trojan onto the console and shove it into the chip. 🤖❌ The chip smokes and dies. You collapse on the bed for a second… you wake up, NO chip, yourself again (the Carpo). 😮‍💨🎸 Everything\'s back to normal. (It can happen again if you go into the love hotel.)',
    'g.chip.hint.linyeras': '“They chipped you, kid, I know. Call us on the phone… we\'ll laugh a bit anyway. Hint: the Garbarino guy knows.” 📱',
    ...
    'g.chip.hint.consola': '“You still need the old console. The TecToys and Commodore retirees are at the cinema, the Consoles floor. They get it from the corner shop.” 🕹️',
