...
(function () {
  const G = {
    ...
    'g.chip.linyerasPosta': '🫥 Ok, for real now, one drops the truth: “the GARBARINO GUY gets that out. Go to the street electronics shop and talk to the pushy salesman.” The three vanish. 🧑‍💼',
    ...
    'g.chip.cured': '🎮💥 You load the trojan onto the console and shove it into the chip. 🤖❌ The chip smokes, sparks and dies. You get dizzy, COLLAPSE onto the bed and pass out for a while… 😴💤 When you wake up, no more chip: you\'re yourself again, the Carpo. 😮‍💨🎸 Everything\'s back to normal. (It can happen again if you go into the love hotel.)',
    ...
    'g.chip.hint.cure': '“You\'ve got it all: open your inventory [I] and USE the console. That loads the trojan into the chip.” 🎮',
