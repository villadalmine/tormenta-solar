...
(function () {
  const G = {
    ...
    'g.telo.chipped': '🤖💉 The robot grabs you and jams the CHIP into your neck. 😵 Half-robot now, you grab the PHONE off the nightstand and message the hobos… they crack up laughing: “so which SIDE are you playing for now, kid?!” 🤣 After some pointless philosophical back-and-forth, one of them lets slip: “the Garbarino guy can fix this, go see him.” Suddenly you wake up in the bed 😶‍🌫️ and flee to the bar. (The Garbarino-guy quest to get the chip out: COMING SOON.)',
