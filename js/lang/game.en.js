...
(function () {
  const G = {
    ...
    'arc.truco.note0': 'Card 1/2/3 · T: truco · V: envido',
    'arc.truco.controls': '1/2/3 card · T truco · V envido',
    'arc.truco.envNo': 'Envido: the card sharp folds. +6 rubbers.',
    'arc.truco.envWin': 'Envido {pe} to {ae}. Yours! +6 rubbers',
    'arc.truco.envLose': 'Envido {pe} to {ae}. You lost. −6 rubbers',
    'arc.truco.quiero': '“I\'m in!” Truco\'s on: worth 20 rubbers.',
    'arc.truco.noQuiero': '“I fold.” You take the hand! +{stake} rubbers',
    'arc.truco.handWin': 'You won the hand!',
    'arc.truco.handLose': 'He won the hand.',
    'arc.truco.tie': 'Tie.',
    'arc.truco.bigWin': 'YOU WON THE TRUCO!',
    'arc.truco.yourTurn': 'Your turn: card 1/2/3',
    'arc.truco.tHint': ' · T truco',
    'arc.truco.score': 'YOU {p}  -  {ai} SHARP',
    'arc.truco.pot': 'Pot: {stake} rubbers',
    'arc.truco.potDelta': '   (you\'re {sign}{delta})',
