...
(function () {
  const G = {
    ...
    'g.chip.linyerasPosta': '🫥 After messing with you a while, the three drop the truth: “the GARBARINO GUY gets that out. Now YOU\'RE the one who fixes this.” 🔄 You switch to controlling THE GARBARINO GUY (🧑‍💼🤖) — head out to the street electronics shop.',
    'g.chip.garbarino': '🧑‍💼 The Garbarino salesman eyes your chip: “oof, that\'s AI gear, heavy stuff. Not me — but YOU can. From now on you run this, kid.” 🔄 You switch to controlling THE GARBARINO GUY (🧑‍💼🤖 on the HUD). “Go to EducaciónIT: Maxi (floor 4) and Marcos (floor 9) will build you a TROJAN.”',
    ...
    'g.chip.obj.garbarino': '🧑‍💼🤖 You\'re the Garbarino guy (chipped). Go to the street ELECTRONICS shop (Garbarino).',
    'g.chip.obj.troyano': '🧑‍💼🤖 Get the TROJAN: talk to MAXI (EducaciónIT fl.4) and MARCOS (fl.9).',
    'g.chip.obj.consola': '🧑‍💼🤖 Go to the CINEMA (Consoles floor): the 2 retirees take you to get the console.',
    'g.chip.obj.consola2': '🧑‍💼🤖 Take the retirees to the ARCADE: the Trucotron guy gives you the console.',
    'g.chip.obj.cure': '🤖 Find ANY hobo and give them the console so they get the chip out.',
