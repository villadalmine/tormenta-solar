...
const LANG_EN = {
  ...
  'intro.controls': '<strong>A/D or ←/→</strong> run · <strong>W / Space</strong> jump · <strong>Mouse</strong> aim · <strong>Click (hold)</strong> shoot · <strong>E</strong> use door / buy · <strong>M</strong> music · <strong>P</strong> your run (your metrics)',
