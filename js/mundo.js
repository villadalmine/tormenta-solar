      ...
      switch (e.tipo) {
        ...
        case 'door': {
          ...
          const d = { id: e.id.split('/door-')[1] || e.id, art: e.render && e.render.type, facade: e.render && e.render.facade,
            label: e.label, x: f.x, y: f.y, inward: e.inward, to: null, at: null, collapsesOnStorm: !!e.collapsesOnStorm, gate: e.gate || null, _toRoom: link.to,
        ...
        case 'npc': {
          ...
          room.npcs.push({ name: e.name, sprite: e.render && e.render.sprite, dialog: e.dialogue && e.dialogue.text,
            action: it.action, follow: it.follow, lines: it.lines, want: it.want, hint: it.hint, oracle: it.oracle, jubilado: it.jubilado, consolaGuy: it.consolaGuy, ambient: e.ambient, social: e.social,
