...
(async () => {
  ...
  try {
    ...
    $('cadena').innerHTML = '<b>Qué modelo usa cada parte del juego, AHORA</b> <span class="muted">(entre paréntesis, el modelo real detrás del alias)</span>:' +
      ...
      '<div class="muted" style="margin:.2rem 0 .45rem 1.5rem">🧠 <b>YA vive (premium, v373):</b> memoria individual — los personajes con chat (el cura, la referente del comedor, el tahúr, los oráculos…) se acuerdan de hechos puntuales CON VOS, no solo la memoria de barrio genérica que ve todo el mundo. Se suma NPC por NPC, editando su ficha del grafo.</div>' +
