...
(async () => {
  ...
  try {
    ...
    $('cadena').innerHTML = '<b>Which model each part of the game uses, RIGHT NOW</b> <span class="muted">(in parentheses, the real model behind the alias)</span>:' +
      ...
      '<div class="muted" style="margin:.2rem 0 .45rem 1.5rem">🧠 <b>coming soon (premium, in design, NOT live yet):</b> individual memory — the oracles and the quest characters (Iorio, the priest, the card shark, the drunks…) will remember specific things ABOUT YOU, not just the generic neighborhood-wide memory everyone sees today.</div>' +
