...
if (require.main === module) {
  ...
  if (v2n !== 50) { console.error('❌ motor v2: Mundo.fromModel(LEVEL1) construyó ' + v2n + ' salas (esperaba 50)'); process.exit(1); }
  ...
  else console.log('✓ paridad v1↔v2: misma estructura (puertas/máquinas/npcs/cueveros) en las 50 salas');
